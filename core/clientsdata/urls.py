...
from clientsdata.views import DeleteClientData, ClientsDataList, AddClientData, UpdateClientData, generate_excel_report_client
from . import views
...
urlpatterns = [
    ...
    path('<int:pk>/report', generate_excel_report_client, name='generate_report_client'),
    path('report/', ClientsDataList.generate_excel_report_allclients, name='generate_excel_report_allclients')
]